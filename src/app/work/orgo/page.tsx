    ...
    <div className="min-h-screen bg-white relative">
      ...
      <div className="mx-auto pt-20 content-with-sidebar" style={{ maxWidth: 'var(--max-width)' }}>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-6 mb-12 p-8 bg-gradient-to-br from-gray-50 to-white border border-[rgba(0,0,0,0.08)] shadow-sm">
            <div>
        ...
        <section id="problem" className="mb-32 scroll-mt-32">
          ...
          <ol className="space-y-4 text-[1.1rem] text-[#666] leading-[1.8] mb-12 ml-6">
            {[
