        ...
        <section className="mb-20" id="work">
          <div className="grid gap-12">
            ...
            <div className="grid gap-8 auto-rows-fr projects-grid">
              ...
              <ProjectCard
                href="/archive/work/inkbench-ez-mode"
              ...
              <ProjectCard
                href="/archive/work/newport-in-bloom"
