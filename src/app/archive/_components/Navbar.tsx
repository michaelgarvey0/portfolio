    ...
    <>
      ...
      >
        <div className="mx-auto flex justify-between items-center px-6 py-3 lg:px-12 lg:py-6" style={{ maxWidth: 'var(--max-width)' }}>
          <Link href="/archive/work" className="text-2xl font-bold text-[#1e3f66] hover:text-[#0d243f] transition-colors" style={{ letterSpacing: 0 }}>
            Michael Garvey
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-10">
            <div className="relative group">
              <Link href="/archive/work" className="text-[0.95rem] font-medium text-[#666] hover:text-[#1a1a1a] transition-colors duration-300 flex items-center gap-2">
                Work
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="12"
            ...
            <Link href="/archive/about" className="text-[0.95rem] font-medium text-[#666] hover:text-[#1a1a1a] transition-colors duration-300 mr-4 ml-2">
              About
            </Link>
            <a href="/archive" onClick={handleExit} className="text-[0.95rem] font-medium text-[#666] hover:text-[#1a1a1a] transition-colors duration-300 cursor-pointer flex items-center gap-2">
              Exit
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
